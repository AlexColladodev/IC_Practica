...
epochs_g = 50
batch_size_g = 32
learning_rate_g = 0.01 #0.01 o 0.005
momentum_g = 0.95 #0.9 o 0.95
patience_g = 8 # 7
...
model = Sequential([
    Conv2D(128, (3, 3), activation='relu', kernel_initializer='he_normal', input_shape=(28, 28, 1)),
    BatchNormalization(),
...
early_stopping = EarlyStopping(monitor='val_loss', patience=patience_g, restore_best_weights=False)
reduce_lr = ReduceLROnPlateau(monitor='val_loss', factor=0.7, patience=2, min_lr=1e-6) # 3 - 0.5 o 0.75
