...
early_stopping = EarlyStopping(monitor='val_accuracy', patience=patience_g, restore_best_weights=False)
reduce_lr = ReduceLROnPlateau(monitor='val_loss', factor=0.75, patience=2, min_lr=1e-6) # 3 - 0.5 o 0.75
