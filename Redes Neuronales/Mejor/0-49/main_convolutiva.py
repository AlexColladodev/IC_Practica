...
epochs_g = 50
batch_size_g = 32
learning_rate_g = 0.008 #0.01 o 0.005
momentum_g = 0.9 #0.9 o 0.95
patience_g = 8 # 7
...
early_stopping = EarlyStopping(monitor='val_accuracy', patience=patience_g, restore_best_weights=True)
